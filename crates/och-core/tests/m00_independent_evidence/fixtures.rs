...
impl RawError {
    pub const fn name(self) -> &'static str {
        match self {
            ...
            Self::InvalidSourceSchemaVersion => "InvalidSourceSchemaVersion",
            Self::CaptureRunTimeOrder => "CaptureRunTimeOrder",
            Self::SourceEndpointSystemMismatch => "SourceEndpointSystemMismatch",
            Self::CaptureRunEndpointMismatch => "CaptureRunEndpointMismatch",
            Self::SourceSnapshotRunMismatch => "SourceSnapshotRunMismatch",
            Self::SourceProjectionRequired => "SourceProjectionRequired",
            Self::SourceIntervalMismatch => "SourceIntervalMismatch",
            Self::SourceLifecycleBindingMismatch => "SourceLifecycleBindingMismatch",
            ...
            Self::DuplicateSourceEvidenceId => "DuplicateSourceEvidenceId",
            Self::SourceRawSnapshotMismatch => "SourceRawSnapshotMismatch",
            Self::SourceNormalizedRawMismatch => "SourceNormalizedRawMismatch",
            Self::SourceNormalizedObservationMismatch => "SourceNormalizedObservationMismatch",
            Self::SourceRawIdempotencyMismatch => "SourceRawIdempotencyMismatch",
            Self::SourceInterpretationMismatch => "SourceInterpretationMismatch",
            Self::SourceGapMismatch => "SourceGapMismatch",
        }
    }
}
