...
uses a slot unreferenced by both valid manifests. A Manifest V1 reference carries
...
| 52 | 2 | sealed format | `1` = raw Journal V1 with Journal Header V1 |
| 54 | 10 | reserved | zero |
...
Manifest V1 publication is the later commit point. A catalog is not authority
