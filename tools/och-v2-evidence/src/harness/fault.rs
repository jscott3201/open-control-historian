...
macro_rules! fault_registry {
    ($(
        ...
        #[derive(Clone, Copy, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
        pub(crate) enum FaultId { $($variant),+ }
        ...
        impl FaultId {
            ...
            pub(crate) const fn source_invoke(self) -> super::v2_io::SiteInvoke {
            ...
            pub(crate) const fn descriptor(self) -> FaultDescriptor {
                match self {
        ...
        $(
            ...
            fn $variant(
                io: &mut super::v2_io::V2Io<'_>,
                selection: Option<FaultSelection>,
            ) -> Result<super::v2_io::SiteResult> {
...
pub(crate) struct FaultDescriptor {
    ...
    pub(crate) maximum_occurrence: u32,
    pub(crate) commit_side: CommitSide,
    pub(crate) expected_root: RootClassification,
    pub(crate) successors: &'static [FaultId],
    pub(crate) terminals: &'static [TerminalState],
}

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(crate) struct FaultSelection {
    pub(crate) id: FaultId,
    pub(crate) occurrence: NonZeroU32,
    pub(crate) mode: FaultMode,
    pub(crate) pressure: PressureKind,
}
...
pub(crate) fn applicability_rows() -> Result<Vec<FaultSelection>> {
