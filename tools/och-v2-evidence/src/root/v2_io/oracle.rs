...
pub(super) const MARKER_BYTES: usize = 32;
pub(super) const INTENT_BYTES: usize = 128;
pub(super) const MANIFEST_BYTES: usize = 160;
pub(super) const CATALOG_MAX_ENTRIES: usize = 64;
pub(super) const CATALOG_HEADER_BYTES: usize = 64;
pub(super) const CATALOG_ENTRY_BYTES: usize = 80;
pub(super) const CATALOG_MAX_BYTES: usize = 5_188;
...
pub(super) struct CatalogEntry {
    ...
    pub(super) sequence_floor: u64,
    pub(super) sequence_cutoff: u64,
    pub(super) source_end: u64,
    pub(super) registry_generation: u64,
    pub(super) raw: ArtifactIdentity,
    pub(super) segment: ArtifactIdentity,
}

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(super) struct TransactionRelation {
    pub(super) store_id: [u8; 16],
...
pub(super) fn marker(store_id: [u8; 16]) -> [u8; MARKER_BYTES] {
...
pub(super) fn validate_marker(bytes: &[u8], store_id: [u8; 16]) -> Result<()> {
...
pub(super) fn intent(relation: TransactionRelation) -> Result<[u8; INTENT_BYTES]> {
...
pub(super) fn validate_intent(bytes: &[u8], relation: TransactionRelation) -> Result<()> {
...
pub(super) fn catalog(store_id: [u8; 16], entries: &[CatalogEntry]) -> Result<Vec<u8>> {
...
pub(super) fn identity(bytes: &[u8]) -> Result<ArtifactIdentity> {
    Ok(ArtifactIdentity {
...
pub(super) fn validate_foundation_oracles() -> Result<()> {
